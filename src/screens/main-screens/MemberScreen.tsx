...
const users = [
  { id: "1", name: "Nguyen Van A", avatar: "https://i.pravatar.cc/150?img=1" },
  { id: "2", name: "Tran Thi B", avatar: "https://i.pravatar.cc/150?img=2" },
  { id: "3", name: "Le Van C", avatar: "https://i.pravatar.cc/150?img=3" },
  { id: "4", name: "Pham Van D", avatar: "https://i.pravatar.cc/150?img=4" },
];
